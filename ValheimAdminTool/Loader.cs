    ...
    class Loader
    {
        public static void Init()
        {
            if (Loader.s_entryPoint == null)
            {
                ...
                UnityEngine.Object.DontDestroyOnLoad(Loader.s_entryPoint);
            }
        }
        ...
        private static void RunPatches()
        {
            foreach (Type type in Assembly.GetExecutingAssembly().GetTypes())
            {
                ...
                {
                    Debug.LogWarning("[ValheimAdminTool] Skipped Harmony patch " + type.FullName + ": " + ex.Message);
                }
            }
        }
        ...
        private static readonly Harmony s_harmony = new Harmony("ValheimAdminTool");
    }
}
