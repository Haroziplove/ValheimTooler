...
namespace ValheimAdminTool.Utils
{
    public static class ConfigManager
    {
        ...
        public static ConfigEntry<float> s_actionRadius;
        ...
        {
            get { return s_actionRadius != null ? s_actionRadius.Value : 20f; }
        }

        public static float UiScale
        {
            get { return s_uiScale != null ? Mathf.Clamp(s_uiScale.Value, 0.6f, 1.8f) : 1f; }
        }
        ...
        static ConfigManager()
        {
            ...
            if (File.Exists(configPathFilePath))
            {
                ...
                {
                    ZLog.Log("[ValheimAdminTool - ConfigManager] Path given in config_vt.path file is incorrect.");
                    configPath = "";
                }
            }
            else
            {
                ZLog.Log("[ValheimAdminTool - ConfigManager] Failed to find config_vt.path file.");
            }
            ...
            s_actionRadius = s_internalFile.Bind("Internal", "ActionRadius", 20f);
