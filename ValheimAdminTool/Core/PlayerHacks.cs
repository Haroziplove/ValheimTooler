...
using ValheimAdminTool.Models;
using ValheimAdminTool.Patches;
            ...
            GUILayout.BeginHorizontal();
            {
                GUILayout.BeginVertical();
                {
                    UI.Controls.BeginSection("$vt_player_general_title");
                    {
                        ...
                        if (UI.Controls.FeatureButton("$vt_player_no_placement_cost", IsNoPlacementCostActive(), s_noPlacementMethod, ConfigManager.s_noPlacementCostShortcut.Value, false, true))
                        {
                        ...
                        // Far interaction is disabled because it conflicts with other mods.
                        //GUILayout.BeginHorizontal();
                        //{
