...
namespace ValheimAdminTool
{
    public class EntryPoint : MonoBehaviour
    {
        ...
        private static void StartFeature(Action start, string name)
        {
            ...
            {
                Debug.LogWarning("[ValheimAdminTool] Failed to start " + name + ": " + ex.Message);
            }
        }
        ...
        private static bool ToggleModifiersHeld(ValheimAdminTool.Configuration.KeyboardShortcut shortcut)
        {
        ...
        void ValheimAdminToolWindow(int windowID)
        {
            HandleToggleHotkey();
            HandlePassThroughHotkey();
