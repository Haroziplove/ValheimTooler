...
using ValheimAdminToolLauncher.Properties;
using ValheimAdminToolLauncher.Views;
using System.Collections.Generic;

namespace ValheimAdminToolLauncher.ViewModels
{
    public class MainWindowViewModel : ViewModel
    {
        ...
        private async void ExecuteOnWindowLoadedCommand(object parameter)
        {
            ...
            if (_isUpgrade)
            {
                Status = "Upgrading ValheimAdminTool...";
                await Task.Run(() =>
                {
                    _installer.Upgrade();
                });
